...
> Last Updated: 2026-04-01 12:57 (v1.36.0)

---

## v1.36.0 (2026-04-01 12:57) - 传感器-控制集成测试 + AGV五级规格增强

### 本次更新
1. **传感器-控制集成测试** ✅
   - 新增 `tests/integration_pipeline_tests.py` (19项测试)
   - 传感器-融合-控制完整流水线测试
   - 触觉/力觉/IMU与控制器闭环测试
   - 多模态传感器同步测试
   - AGV五级流水线合规验证

2. **AGV五级规格完整对照表 v1.5.0** ✅
   - 新增第八章: 感知-控制集成五级规格
     - 触觉-控制集成规格 (M级: 100Hz闭环, ±10%精度)
     - 力觉-控制集成规格 (L级: 8Hz力控带宽, ±5%精度)
