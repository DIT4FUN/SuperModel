...
- **v2.02.0** (2026-04-09): 新增EmbodiedController.run()仿真循环方法 + run_five_grade_benchmark()五级基准测试 + create_for_grade()工厂方法; 368项传感器+融合测试全通过; 1793项测试全通过
- **v2.01.0** (2026-04-09): 新增AGV五级规格总表(附录L): 整车/感知/控制/计算/安全/延迟/AI能力全覆盖, 283项传感器测试+73项融合测试全通过
- **v2.00.1** (2026-04-09): 融合模块结构优化(cross_modal_fusion.py移至根目录fusion/)，600项测试全通过
